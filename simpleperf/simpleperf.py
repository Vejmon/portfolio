...
# function to check run ifconfig on a node, and get it's ip address
def get_ip():
...
parse.add_argument('-b', '--bind', type=valid_ip, default=get_ip(),
...
parse.add_argument('-I', '--serverip', type=valid_ip, default=get_ip(),
